...
//Сценарий: изменение видов цен по условию
//	//И для каждой строки таблицы "ItemList" я выполняю	- зацикливается
//	И для каждой строки таблицы “ItemList” я выполняю используя колонку “N”
...
Сценарий: создание большого объема данных (справочник Уд. измерения)
